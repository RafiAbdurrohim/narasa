      ...
      <nav className="absolute top-0 w-full z-50 pt-6 md:pt-8 pb-4">
        <div className="container mx-auto px-6 md:px-8 flex items-center justify-between">
          <div className="flex items-center">
            <Image src="/logo.png" alt="NARASA" width={140} height={40} className="h-8 md:h-10 w-auto" priority />
          </div>
          <div className="flex items-center gap-6 md:gap-10 text-sm font-medium text-foreground/80">
            <Link href="/explore" className="hover:text-primary transition-colors hidden sm:block">
              Eksplorasi
            </Link>
            <Link href="/provider" className="hover:text-primary transition-colors hidden sm:block">
              Mitra
            </Link>
            <Link href="/explore">
              <span className="pb-1 border-b-2 border-foreground hover:border-primary transition-colors cursor-pointer text-xs md:text-sm font-bold md:font-medium">Pesan Sekarang</span>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <section className="pt-28 md:pt-32 lg:pt-40 pb-16 md:pb-20 relative">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="w-full h-[40vh] sm:h-[50vh] md:h-[65vh] rounded-[2rem] overflow-hidden relative group">
            <img src="https://www.kutairaya.com/newsphoto/20250811tempat.jpeg" alt="Kampung Ketupat Landscape" className="w-full h-full object-cover transition-transform duration-[20s] group-hover:scale-110" />
      ...
      <section className="py-24 bg-white relative z-10">
        <div className="container mx-auto px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            ...
            <p className="text-foreground/60 max-w-sm md:text-right font-medium">Dari kelezatan kuliner halal hingga kerajinan tangan otentik, temukan daya tarik Kampung Ketupat.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:h-[500px]">
            ...
            <Link href="/explore" className="md:col-span-2 md:row-span-2 relative rounded-3xl overflow-hidden group h-[300px] md:h-auto block">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTezhMZud0wXnwNgRL243R4pcBpoNBLcFDyiNZZm5CQSA&s=10"
            ...
            <Link href="/explore" className="md:col-span-2 relative rounded-3xl overflow-hidden group h-[250px] md:h-auto block">
              <img
                src="https://asset.tribunnews.com/QySuwLvVAPtI5KXU9vkG9If9jq4=/1200x675/filters:upscale():quality(30):format(webp):focal(0.5x0.5:0.5x0.5)/banjarmasin/foto/bank/originals/anyaman-ketupat-dari-daun-nipahsafas.jpg"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                alt="Craft"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
            ...
            <Link href="/explore" className="relative rounded-3xl overflow-hidden group h-[200px] md:h-auto block">
              <img
                src="https://www.indonesia.travel/contentassets/ec44797b4af641779299983bb1829630/kampung-ketupat-kalimantan-timur-wisata-kuliner-unik.jpg"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                alt="Culture"
              />
            ...
            <Link href="/explore" className="relative rounded-3xl overflow-hidden bg-primary/10 group h-[200px] md:h-auto flex items-center justify-center text-center p-6 border border-primary/20 hover:bg-primary transition-colors">
              <div>
                <h3 className="font-serif text-2xl text-primary group-hover:text-white transition-colors mb-2">
                  Semua
                  <br />
                  Kategori
                </h3>
              ...
              <div key={exp.id} className={`flex flex-col ${index % 2 !== 0 ? "md:flex-row-reverse" : "md:flex-row"} gap-10 md:gap-16 items-center`}>
                ...
                <div className="w-full md:w-2/5 flex flex-col justify-center">
                  ...
                  <Link href={`/experience/${exp.id}`}>
                    <h3 className="font-serif text-3xl md:text-4xl font-medium leading-tight mb-6 hover:text-primary transition-colors">{exp.title}</h3>
                  </Link>

                  <p className="text-foreground/70 leading-relaxed mb-8 line-clamp-3">{exp.description}</p>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-[2.5rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 max-w-6xl mx-auto">
            ...
            <div className="w-full md:w-[400px] shrink-0 relative">
              <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img src="https://jurnalborneo.com/wp-content/uploads/2025/08/yjswr44j6.jpg" alt="Kampung Ketupat" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="bg-white border border-black/5 shadow-sm p-6 rounded-2xl flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-foreground/60 leading-relaxed">
                    Jl. Mangkupelas, Mesjid, Kec. Samarinda Seberang,
                    <br /> Kota Samarinda, Kalimantan Timur 75133
                  </div>
                </div>
              </div>
            </div>
